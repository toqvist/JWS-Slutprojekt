...
public class GreeterController {
    ...
    public String greet() {
        ...
        htmlString += "<li>/calc - accepts parameters , value1 and value2</li>";
        htmlString += "<li>/RSP - <li>";
        htmlString += "<li>/Rock-paper-scissors - accepts parameters OPERATION, value1 and value2</li>";
